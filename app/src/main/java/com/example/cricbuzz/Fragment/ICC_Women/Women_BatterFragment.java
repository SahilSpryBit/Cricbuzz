...
public class Women_BatterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women__batter, container, false);

        apiInterface = RetrofitInstance.getRetrofit().create(ApiInterface.class);
        recyclerView = view.findViewById(R.id.recyclerView_batsmen_W);
        txtTest = view.findViewById(R.id.txtTest_batsmen_W);
        txtOdi = view.findViewById(R.id.txtOdi_batsmen_W);
        txtT20 = view.findViewById(R.id.txtT20_batsmen_W);
    ...
    private void ApiCall(String type){
        ...
        apiInterface.getIccRankingWomens_Batsmen(MainActivity.apiKey, "cricbuzz-cricket.p.rapidapi.com", type, "1").enqueue(new Callback<MyDataClass>() {
            @Override
