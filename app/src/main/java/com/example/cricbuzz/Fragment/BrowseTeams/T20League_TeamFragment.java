...
public class T20League_TeamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_t20_league__team, container, false);
    ...
    private void ApiCall(){
        ...
        apiInterface.getBrowseTeams_League(MainActivity.apiKey).enqueue(new Callback<list>() {
            @Override
