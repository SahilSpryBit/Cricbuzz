...
import com.example.cricbuzz.Adapter.IccMensRanking_Teams_Adapter;
...
public class Women_ICC_TeamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_women__team2, container, false);

        apiInterface = RetrofitInstance.getRetrofit().create(ApiInterface.class);
        recyclerView = view.findViewById(R.id.recyclerView_team_W);
        txtTest = view.findViewById(R.id.txtTest_team_W);
        txtOdi = view.findViewById(R.id.txtOdi_team_W);
        txtT20 = view.findViewById(R.id.txtT20_team_W);
    ...
    private void ApiCall(String type){
        ...
        apiInterface.getIccRankingWomens_Teams(MainActivity.apiKey, "cricbuzz-cricket.p.rapidapi.com", type, "1").enqueue(new Callback<MyDataClass>() {
            @Override
            public void onResponse(Call<MyDataClass> call, Response<MyDataClass> response) {
                ...
                if(response.isSuccessful()){
                    if(response.body() != null){
                        ...
                        IccMensRanking_Teams_Adapter iccMensRankingTeamsAdapter = new IccMensRanking_Teams_Adapter(getContext(), ranks);
                        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
                        recyclerView.setAdapter(iccMensRankingTeamsAdapter);
