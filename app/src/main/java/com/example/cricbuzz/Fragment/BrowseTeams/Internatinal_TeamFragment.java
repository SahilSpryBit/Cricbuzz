...
public class Internatinal_TeamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_internatinal__team, container, false);
    ...
    private void ApiCall(){
            ...
            apiInterface.getBrowseTeams_International(MainActivity.apiKey).enqueue(new Callback<list>() {
                @Override
