...
public class Men_TeamFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_men__team, container, false);

        apiInterface = RetrofitInstance.getRetrofit().create(ApiInterface.class);
        recyclerView = view.findViewById(R.id.recyclerView_team);
        txtTest = view.findViewById(R.id.txtTest_team);
        txtOdi = view.findViewById(R.id.txtOdi_team);
        txtT20 = view.findViewById(R.id.txtT20_team);
    ...
    private void ApiCall(String type){
        ...
        apiInterface.getIccRankingMens_Teams(MainActivity.apiKey, "cricbuzz-cricket.p.rapidapi.com", type).enqueue(new Callback<MyDataClass>() {
            @Override
