...
public class IccMensRanking_AllRounder_Adapter extends RecyclerView.Adapter<IccMensRanking_AllRounder_Adapter.ViewHolder> {

    Context context;
    List<rank> ranks;

    public IccMensRanking_AllRounder_Adapter(Context context, List<rank> ranks) {
    ...
    @NonNull
    @Override
    public IccMensRanking_AllRounder_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.icc_rankings_layout, parent, false);
        return new IccMensRanking_AllRounder_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull IccMensRanking_AllRounder_Adapter.ViewHolder holder, int position) {
