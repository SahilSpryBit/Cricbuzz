...
public class Live_International_Matches_Adapter extends RecyclerView.Adapter<Live_International_Matches_Adapter.ViewHolder> {

    Context context;
    com.example.cricbuzz.Model.typeMatches[] typeMatches;

    public Live_International_Matches_Adapter(Context context, com.example.cricbuzz.Model.typeMatches[] typeMatches) {
