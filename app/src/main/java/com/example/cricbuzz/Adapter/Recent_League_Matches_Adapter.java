...
public class Recent_League_Matches_Adapter extends RecyclerView.Adapter<Recent_League_Matches_Adapter.ViewHolder> {

    Context context;
    com.example.cricbuzz.Model.typeMatches[] typeMatches;

    public Recent_League_Matches_Adapter(Context context, com.example.cricbuzz.Model.typeMatches[] typeMatches) {
    ...
    @NonNull
    @Override
    public Recent_League_Matches_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.live_all_formate_matches_layout, parent, false);
        return new Recent_League_Matches_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Recent_League_Matches_Adapter.ViewHolder holder, int position) {
