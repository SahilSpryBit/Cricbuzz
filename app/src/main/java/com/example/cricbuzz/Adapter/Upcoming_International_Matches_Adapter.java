...
public class Upcoming_International_Matches_Adapter extends RecyclerView.Adapter<Upcoming_International_Matches_Adapter.ViewHolder> {

    Context context;
    com.example.cricbuzz.Model.typeMatches[] typeMatches;
    int newData;

    public Upcoming_International_Matches_Adapter(Context context, com.example.cricbuzz.Model.typeMatches[] typeMatches) {
    ...
    @NonNull
    @Override
    public Upcoming_International_Matches_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.live_all_formate_matches_layout, parent, false);
        return new Upcoming_International_Matches_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Upcoming_International_Matches_Adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
