...
public class IccMensRanking_Bowler_Adapter extends RecyclerView.Adapter<IccMensRanking_Bowler_Adapter.ViewHolder> {

    Context context;
    List<rank> ranks;

    public IccMensRanking_Bowler_Adapter(Context context, List<rank> ranks) {
    ...
    @NonNull
    @Override
    public IccMensRanking_Bowler_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.icc_rankings_layout, parent, false);
        return new IccMensRanking_Bowler_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull IccMensRanking_Bowler_Adapter.ViewHolder holder, int position) {
