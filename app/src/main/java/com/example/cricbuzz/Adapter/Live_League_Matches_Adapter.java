...
public class Live_League_Matches_Adapter extends RecyclerView.Adapter<Live_League_Matches_Adapter.ViewHolder> {

    Context context;
    com.example.cricbuzz.Model.typeMatches[] typeMatches;

    public Live_League_Matches_Adapter(Context context, typeMatches[] typeMatches) {
